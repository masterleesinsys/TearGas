...
public class VisitInfo implements Serializable {
    ...
    private String mplatform; // 平台
    private String mdevice_UID; // 设备id
    private String mstart_time; // 进入时间
    private String mnetwork_type; // 网络类型
    private String mip; // IP
    private String mdevice_machine; // 手机型号
    private String mresolution; // 分辨率
    private String mos_version; // 系统版本
    private String mapp_version; // App版本号
    private String mend_time; // 退出时间
