...
//        point_y = UtilTools.Getrandomarray(15, 300);
    ...
    protected void onDraw(Canvas canvas) {
        // TODO Auto-generated method stub
        canvas.drawCircle(viewSize / 2, viewSize / 2, 200, mPaintCircle);
        canvas.drawCircle(viewSize / 2, viewSize / 2, 150, mPaintLine);
        canvas.drawCircle(viewSize / 2, viewSize / 2, 100, mPaintLine);
        canvas.drawCircle(viewSize / 2, viewSize / 2, 200, mPaintLine);
...
//        }
        ...
        canvas.drawCircle(viewSize / 2, viewSize / 2, 200, mPaintSector);
